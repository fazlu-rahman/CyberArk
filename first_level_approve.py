...
username = "ACCOUNT_NAME_FOR_APPROVING_1ST_LEVEL_HERE"
approve1_password = ''  #Best practice is not to hardcode the password. use any secret management solutions such as Hashicorp Vault apis to get the password in real time.
req_id = sys.argv[1]
sender = sys.argv[2]
...
data = '{ "username":"'+username+'","password":"'+approve1_password+'", "useRadiusAuthentication":"false", "connectionNumber":"1"}'
